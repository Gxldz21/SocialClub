...
SECRET_KEY = "django-insecure-d@ora#!$04*(=bmkmj^@207vm@*4&si@u&6p0)+*1bd4#4a*!#"
...
INSTALLED_APPS = [
    ...
    "multiclub.apps.MulticlubConfig",
    "api",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'core.context_processors.pic.pic',
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = 'social:main'
